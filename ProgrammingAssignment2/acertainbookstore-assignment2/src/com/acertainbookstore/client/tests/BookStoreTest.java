...
public class BookStoreTest {
	...
	public void test1() throws BookStoreException {
		...
		addBooks(TEST_ISBN, ITERATIONS);
		addBooks(TEST_ISBN+1,ITERATIONS);
		...
		assertEquals(ITERATIONS, storeManager.getBooksByISBN(new HashSet<>(Collections.singletonList(TEST_ISBN))).get(0).getNumCopies());
		assertEquals(ITERATIONS, storeManager.getBooksByISBN(new HashSet<>(Collections.singletonList(TEST_ISBN + 1))).get(0).getNumCopies());
	}

	/**
	 * Test 2, Two threads, one buys books and add copies, the other one get books
	 *
	 * @throws BookStoreException
	 * 				the book store exception
	 */
	...
	/**
	 * Test 3, Two threads, both add copies
	 *
	 * @throws BookStoreException
	 *             the book store exception
	...
	public void test3() throws BookStoreException, InterruptedException {
		...
		assertEquals(2*ITERATIONS+NUM_COPIES, storeManager.getBooksByISBN(new HashSet<>(Collections.singletonList(TEST_ISBN))).get(0).getNumCopies());
	}
	...
	public void test4() throws BookStoreException {
		...
		assertEquals(ITERATIONS+1, storeManager.getBooksByISBN(new HashSet<>(Collections.singletonList(TEST_ISBN))).get(0).getNumCopies());
		assertEquals(ITERATIONS+1, storeManager.getBooksByISBN(new HashSet<>(Collections.singletonList(TEST_ISBN + 1))).get(0).getNumCopies());
	}
