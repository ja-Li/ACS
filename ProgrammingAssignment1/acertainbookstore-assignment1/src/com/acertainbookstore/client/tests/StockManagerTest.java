...
//	private static boolean localTest = true;
	...
	public void testGetBooksInDemand() throws BookStoreException {
		...
		booksToAdd.add(new ImmutableStockBook(TEST_ISBN + 1, "Pattern Recognition and Machine Learning", " Christopher Bishop",
				(float) 300, NUM_COPIES, 1, 0, 0, false));
		storeManager.addBooks(booksToAdd);

		assertEquals("Pattern Recognition and Machine Learning", storeManager.getBooksInDemand().get(0).getTitle());
	}
