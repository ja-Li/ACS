...
public enum BookStoreMessageTag {
	...
	/** The tag for the get stock books by rate message. */
	RATEBOOKS,

	/** The tag for the get stock books by getTopRate message. */
	TOPRATEDBOOKS,

	/** The tag for the get stock books by getBooksInDemand message. */
	BOOKSINDEMAND;
}
